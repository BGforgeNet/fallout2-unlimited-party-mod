...
- It affects the following companions:
    ...
    * Sulik
    * Vic
- Tested on Windows XP x86. If you have any issues, reach me on github (burner1024). Attach logs (fallout2-unlimited-party-mod-master/tools/logs) so I could debug.
