...
Note the following:
1) It does not remove other checks (karma, etc). Companions may still refuse to join because of that.
2) It only affects joinable persistent companions, namely: Vic, Dogmeat, Lenny, Marcus, Sulik, Miron, Goris, Cassidy, Robodog, Brain bot. Others should join you anyway.
3) It should be compatible with _any_ other mod provided that unlimited party is installed last. It patches files instead of overwriting them.
4) Start a new game after installation
